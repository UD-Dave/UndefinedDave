...
var WebdriverIO = function WebdriverIO(args, modifier) {
    ...
    if (!options.capabilities) {
        options.capabilities = options.desiredCapabilities;
    }

    var w3cCaps = {};
    var jsonwpCaps = {};
    var isW3cCapsFormat = options.capabilities && options.capabilities.alwaysMatch;
    if (isW3cCapsFormat) {
        w3cCaps = options.capabilities;
        jsonwpCaps = options.capabilities.alwaysMatch;
    } else {
        w3cCaps = { alwaysMatch: options.capabilities, firstMatch: [{}] };
        jsonwpCaps = options.capabilities;
    }

    var desiredCapabilities = jsonwpCaps;
    ...
    function unit(lastPromise) {
        ...
        client.isW3cCapsFormat = isW3cCapsFormat;
        client.capabilities = w3cCaps; // W3C compliant
        client.desiredCapabilities = desiredCapabilities; // JSONWP compliant
