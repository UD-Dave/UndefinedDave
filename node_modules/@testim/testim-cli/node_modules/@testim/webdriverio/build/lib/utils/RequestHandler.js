...
var RequestHandler = function () {
    ...
    (0, _createClass3.default)(RequestHandler, [{
        ...
        value: function createOptions(requestOptions, data) {
            ...
            if (requestOptions.path === '/session') {
                newOptions.isSessionRequest = true;
        ...
        value: function create(requestOptions, data) {
            ...
            var totalRetryCount = this.defaultOptions.connectionRetryCount;
            if (fullRequestOptions.isSessionRequest) {
                if (this.defaultOptions.getSessionTimeout) {
                    fullRequestOptions.timeout = this.defaultOptions.getSessionTimeout;
                }
                if (this.defaultOptions.getSessionRetries) {
                    totalRetryCount = this.defaultOptions.getSessionRetries;
                }
            }

            return this.request(fullRequestOptions, totalRetryCount).then(function (_ref) {
                var body = _ref.body,
